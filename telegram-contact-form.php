...
function tcf_enqueue_scripts() {
    ...
    wp_enqueue_script('tcf-script', plugin_dir_url(__FILE__) . 'assets/js/tcf-script.js', array('jquery'), '1.0', true);
...
function tcf_render_form() {
    ...
    <form id="telegram-contact-form" class="tcf-form">
        <div class="form-group">
            ...
            <input type="text" id="tcf-name" name="name" required>
        </div>
        <div class="form-group">
            <label for="tcf-email">Email:</label>
            <input type="email" id="tcf-email" name="email" required>
        </div>
        <div class="form-group">
            <label for="tcf-phone">Phone:</label>
            <input type="tel" id="tcf-phone" name="phone" required>
        </div>
        <div class="form-group">
            <label for="tcf-telegram">Telegram Username:</label>
            <input type="text" id="tcf-telegram" name="telegram_username" placeholder="@username" required>
        </div>
        <div class="form-group">
            <label for="tcf-message">Message:</label>
            <textarea id="tcf-message" name="message" required></textarea>
        </div>
...
function tcf_submit_form() {
    ...
    $telegram_message .= "Telegram: $telegram_username\n";
